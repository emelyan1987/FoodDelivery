...
// Chat
$route['chat_list'] = 'Administration/ChatController/chat_list';
$route['chat_window'] = 'Administration/ChatController/chat_window';
$route['chat_messages_ajax'] = 'Administration/ChatController/chat_messages_ajax';

/* ================= AdminPanel for RestroOwner =============*/
...
$route['customer_chat_window'] = 'Customer/chat_window';
...
$route['api/users/address/(:num)'] = '/api/UserController/address/$1'; 
...
$route['api/data/faqs'] = '/api/DataController/faqs'; 
...
$route['api/orders/reserve/(:num)'] = '/api/OrderController/reserve/$1'; 
$route['api/orders/my_points'] = '/api/OrderController/my_points'; 
$route['api/orders/(:num)/cancel'] = '/api/OrderController/cancel/$1'; 
