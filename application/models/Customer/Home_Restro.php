<?php if (!defined('BASEPATH')) {
    ...
    class Home_Restro extends CI_Model {
        ...
        public function get_restro_location($restro_id) {
            $this->db->select('restro_location.location_name,restro_location.telephones');
            $this->db->from('restro_location');
            $this->db->where('restro_location.restro_id', $restro_id);
            $this->db->where('restro_location.location_name !=', NULL);
        ...
        public function all_restro() {
            ...
            $this->db->select('restro_info.*,restro_working_hour.min_order as RestroMin,restro_working_hour.location_id,restro_working_hour.order_days,restro_working_hour.order_hour,restro_working_hour.order_minitue,restro_working_hour.order_second,restro_payments_method.method_type,restro_services_commission.service_type,GROUP_CONCAT(restro_promotion.id) as promotion', false);
            $this->db->from('restro_info');
            $this->db->join('restro_services_commission', 'restro_info.id = restro_services_commission.restro_id');
            $this->db->join('restro_promotion', 'restro_promotion.service_id = restro_services_commission.service_type AND restro_promotion.to_date >= CURDATE()', 'left');
        ...
        public function all_restro_tables() {
            $service_id = $_SESSION['filter_service'];
            $area = $_SESSION['filter_city'];
            $this->db->select('restro_info.*,restro_working_hour.min_order as RestroMin,restro_working_hour.monday_from,restro_working_hour.friday_to,restro_working_hour.saturday_from,restro_working_hour.sunday_to,restro_services_commission.service_type,GROUP_CONCAT(restro_promotion.id) as promotion', false);
            $this->db->from('restro_info');
            $this->db->join('restro_services_commission', 'restro_info.id = restro_services_commission.restro_id');
            $this->db->join('restro_promotion', 'restro_promotion.service_id = restro_services_commission.service_type AND restro_promotion.to_date >= CURDATE()', 'left');
            $this->db->join('restro_working_hour', 'restro_info.id = restro_working_hour.restro_id');
        ...
        public function all_restro_by_service($service_id, $cus, $city_id) {
            ...
            $this->db->select('restro_info.*,restro_working_hour.min_order as RestroMin,restro_working_hour.order_days,restro_working_hour.order_hour,restro_working_hour.order_minitue,restro_working_hour.order_second,restro_payments_method.method_type,restro_services_commission.service_type,GROUP_CONCAT(restro_promotion.id) as promotion', false);
            $this->db->from('restro_info');
            $this->db->join('restro_services_commission', 'restro_info.id = restro_services_commission.restro_id');
            $this->db->join('restro_promotion', 'restro_promotion.service_id = restro_services_commission.service_type AND restro_promotion.to_date >= CURDATE()', 'left');
        ...
        public function view_restro_details($id) {
            $service_id = $_SESSION['filter_service'];
            $this->db->select('restro_info.*,restro_working_hour.min_order as RestroMin,restro_payments_method.method_type,,restro_services_commission.service_type,GROUP_CONCAT(restro_promotion.id) as promotion', false);
            $this->db->from('restro_info');
            $this->db->join('restro_services_commission', 'restro_info.id = restro_services_commission.restro_id');
            $this->db->join('restro_promotion', 'restro_promotion.service_id = restro_services_commission.service_type AND restro_promotion.to_date >= CURDATE()', 'left');
            $this->db->join('restro_working_hour', 'restro_info.id = restro_working_hour.restro_id', 'left');
            $this->db->join('restro_payments_method', 'restro_info.id = restro_payments_method.restro_id', 'left');
            $this->db->join('restro_location', 'restro_location.id = restro_services_commission.location_id and restro_location.id = restro_working_hour.location_id and restro_location.id = restro_payments_method.location_id and restro_location.restro_id = restro_info.id', 'left');
            $this->db->where('restro_info.status !=', 0);
            $this->db->where('restro_working_hour.service_id', $service_id);
            $this->db->where('restro_services_commission.service_type', $service_id);
        ...
        public function restro_table_checkout_details($id) {
            $area = $_SESSION['filter_city'];
            $service_id = $_SESSION['filter_service'];
            $this->db->select('restro_info.*,restro_working_hour.min_order as RestroMin,restro_working_hour.monday_from,restro_working_hour.friday_to,restro_working_hour.sunday_to,restro_working_hour.saturday_from,restro_working_hour.happy_from,restro_working_hour.happy_to,restro_payments_method.method_type,restro_services_commission.service_type,GROUP_CONCAT(restro_promotion.id) as promotion', false);
            $this->db->from('restro_info');
            $this->db->join('restro_services_commission', 'restro_info.id = restro_services_commission.restro_id');
            $this->db->join('restro_promotion', 'restro_promotion.service_id = restro_services_commission.service_type AND restro_promotion.to_date >= CURDATE()', 'left');
            $this->db->join('restro_payments_method', 'restro_info.id = restro_payments_method.restro_id', 'left');
        ...
        public function all_restro_by_city($area, $service_id) {
            $where = "FIND_IN_SET('" . $area . "', restro_city_area.area)";
            $this->db->select('restro_info.*, restro_location.location_name, restro_location.location_contact_person, restro_location.latitude, restro_location.longitude, restro_location.block, restro_location.street, restro_location.building, restro_location.id AS location_id,restro_working_hour.min_order as RestroMin,restro_working_hour.order_days,restro_working_hour.order_hour,restro_working_hour.order_minitue,restro_working_hour.order_second,restro_payments_method.method_type,restro_working_hour.service_id,restro_working_hour.location_id,restro_services_commission.service_type,GROUP_CONCAT(restro_promotion.id) as promotion', false);
            $this->db->from('restro_info');
            $this->db->join('restro_services_commission', 'restro_info.id = restro_services_commission.restro_id');
            $this->db->join('restro_promotion', 'restro_promotion.service_id = restro_services_commission.service_type AND restro_promotion.to_date >= CURDATE()', 'left');
            $this->db->join('restro_city_area', 'restro_info.id = restro_city_area.restro_id');
        ...
        public function all_restro_by_filter($service_id) {
            $this->db->select('restro_info.*,restro_working_hour.min_order as RestroMin,restro_working_hour.order_days,restro_working_hour.order_hour,restro_working_hour.order_minitue,restro_working_hour.order_second,restro_payments_method.method_type,restro_working_hour.service_id,restro_working_hour.location_id,restro_services_commission.service_type,GROUP_CONCAT(restro_promotion.id) as promotion', false);
            $this->db->from('restro_info');
            $this->db->join('restro_services_commission', 'restro_info.id = restro_services_commission.restro_id');
            $this->db->join('restro_promotion', 'restro_promotion.service_id = restro_services_commission.service_type AND restro_promotion.to_date >= CURDATE()', 'left');
            $this->db->join('restro_city_area', 'restro_info.id = restro_city_area.restro_id');
        ...
        public function all_tables_by_location_city($area, $service_id) {
            ...
            $this->db->from('restro_info');
            $this->db->join('restro_services_commission', 'restro_info.id = restro_services_commission.restro_id');
            $this->db->join('restro_promotion', 'restro_promotion.service_id = restro_services_commission.service_type AND restro_promotion.to_date >= CURDATE()');
            $this->db->join('restro_working_hour', 'restro_info.id = restro_working_hour.restro_id');
            $this->db->join('restro_tables', 'restro_info.id = restro_tables.restro_id');
            $this->db->join('restro_location', 'restro_location.id = restro_working_hour.location_id and restro_location.id = restro_services_commission.location_id and restro_location.restro_id = restro_info.id');
            $this->db->where('restro_info.status !=', 0);
        ...
        public function restro_item_details($userid, $item_id) {
            $this->db->select('*');
            // $this->db->join('restro_item_variation iv', 'iv.item_id = tbl_item.id', 'left');
            $this->db->where('tbl_item.user_id', $userid);
            $this->db->where('tbl_item.id', $item_id);
        ...
        public function update_cart($id, $data){
            $this->db->trans_start();
            $this->db->where('id',  $id);
            $this->db->update('restro_cart', $data);
        ...
        public function all_restro_pickup($service_id, $searchtxt, $city_id=NULL) {
            $this->db->select('restro_info.*,restro_working_hour.min_order as RestroMin,restro_working_hour.order_days,restro_working_hour.order_hour,restro_working_hour.order_minitue,restro_working_hour.order_second,restro_payments_method.method_type,restro_services_commission.service_type,GROUP_CONCAT(restro_promotion.id) as promotion', false);
            $this->db->from('restro_info');
            $this->db->join('restro_services_commission', 'restro_info.id = restro_services_commission.restro_id');
            $this->db->join('restro_promotion', 'restro_promotion.service_id = restro_services_commission.service_type AND restro_promotion.to_date >= CURDATE()', 'left');
        ...
        public function getItemVariation($itemid, $variation_type) {
            $this->db->select('restro_item_variation.variation_name,restro_item_variation.multi_item,restro_item_variation_data.*');
