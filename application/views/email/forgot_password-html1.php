...
<br />
<big style="font: 16px/18px Arial, Helvetica, sans-serif;"><b><a href="<?php echo site_url('/home/reset_pass/'.$user_id.'/'.$new_pass_key); ?>" style="color: #3366cc;">Create a new password</a></b></big><br />
<br />
Link doesn't work? Copy the following link to your browser address bar:<br />
<nobr><a href="<?php echo site_url('/home/reset_pass/'.$user_id.'/'.$new_pass_key); ?>" style="color: #3366cc;"><?php echo site_url('/home/reset_pass/'.$user_id.'/'.$new_pass_key); ?></a></nobr><br />
<br />
<br />
