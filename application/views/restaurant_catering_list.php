...
color: #fff;
background-image: -webkit-linear-gradient(to bottom, #ff962f 50%, #ff8205 49%);
background-image: -o-linear-gradient(to bottom, #ff962f 50%, #ff8205 49%);
background-image: linear-gradient(to bottom, #ff962f 50%, #ff8205 49%);
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="filterHeader">
                <img src="/assets/Customer/img/icon/smallLogoOrange.png" alt="">
                <span>Filters</span>
            </div>
            <div class="blueBorder"></div>
            <ul class="filterList">
                <li>
                    <div class="roundedOne roundedOneOrange">
...
foreach ($service_list as $a => $b) {
	...
	?>
                    <li <?php if ($k == 2) {?>class="active" <?php }
...
?>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <a href="/catering_restaurant/<?php echo $vs->id;?>"><h4><?php echo $vs->restro_name;?></h4></a>
                                            <div class="ratings">
                                                <?php
...
?>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <label class="list-data">&nbsp;KD&nbsp;<?php echo number_format($vs->RestroMin, 3);?></label>
                                                <br>
...
?>
                                                    ...
                                                    <div><a href="/catering_restaurant/<?php echo $vs->id;?>" class="list-button">Go to Menu <i class="fa fa-angle-right"></i></a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
