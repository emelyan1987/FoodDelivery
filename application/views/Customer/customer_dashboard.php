						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="col-md-6 col-sm-12">
									<label class="list-label">Order No. :</label><label class="list-data"><a href="/delivery_order_details/<?php echo $ord->id;?>" class="gray">#<?php echo $ord->order_no;?></a></label>
									...
									<label class="list-label">Point Gain/Used :<a href="/customer_dashboard/points"> </label><label class="list-data"><i class="green"><?php echo $ord->order_points;?></i> pt/<i class="red"><?php echo $ord->used_points;?></i> pt</label></a>
									<label class="list-label">Payment :</label><label class="list-data"><?=$payment_method?></label>

									<p>
									<a href="/delivery_order_details/<?php echo $ord->id;?>" class="btn btn-default" style="color:red">Order Details</a>
									<button class="btn btn-default">RE-ORDER <i class="fa  fa-rotate-left btn-icon-right"></i></button>
											<a class="btn btn-default" data-toggle="modal" data-target="#myModal2" onclick="ratPop(&quot;24&quot;,&quot;46&quot;);">Rate it <i class="fa fa-star btn-icon-right"></i></a>
									</p>
...
foreach ($ReservationData as $res => $ResData):
	...
	?>
								<div class="row">
									<div class="col-md-12">
										<div class="col-md-3 col-sm-12">
											<h5 class="text-center">Status <label <?php echo $cls_status;?>><?php echo $title_status;?></label></h5>
											<img class="img-responsive center-block" alt="" src="/assets/Customer/img/partner2.jpg"/>
										</div>
										<div class="col-md-3 col-sm-12">
											<div class="margin40"></div>
										...
										<div class="col-md-6 col-sm-12">
											<div class="margin20"></div>
									<label class="list-label">Reservation No. :</label><label class="list-data">#<?php echo $ResData->order_no;?></label>
											<label class="list-label">Date Time :</label><label class="list-data"><?php echo $ResData->date . " " . $ResData->time;?></label>
									<label class="list-label">Point Gain/Used :<a href="/customer_dashboard/points"> </label><label class="list-data"><i class="green"><?php echo $ResData->order_points;?></i>/<i class="red"><?php echo $ResData->used_points;?></i></label></a>

									<p>
											<a class="btn btn-default" data-toggle="modal" data-target="#myModal2" href="/restaurant_rating/<?php echo $ResData->restro_id;?>" <?=$btnRate?>>Rate it <i class="fa fa-star btn-icon-right"></i></a>
									<a href="#" class="btn btn-default" <?=$btnCancel?>>CANCEL</a>
									<a href="/delivery_order_details/<?php echo $ResData->id;?>" class="btn btn-default" <?=$btnDetail?>>DETAILS</a>
									<button class="btn btn-default" <?=$btnPay?>>PAY </button>
									</p>
									<!--<label class="list-label">Order Details :</label><label>3 medium pizza , one coke , two beers</label>-->
								</div>
...
if ($proData->restaurant_logo != '') {
		...
		echo $img[1];?>" style="height:150px;width: 150px">
													<?php
} else {
		?>
...
<?php foreach ($promotions as $pro => $proData): ?>
									<div class="row grayFont">
										<div class="col-md-12">
											<div class="col-md-3 col-sm-12">
												<h2 class="text-center" style="margin-top: 0;">
												<?php echo ucwords($proData->restro_name);?>
												</h2>
												<?php
if ($proData->restaurant_logo != '') {
	?>
													<img class="img-responsive center-block" alt="" src="<?php $img = explode('public_html', $proData->restaurant_logo);
	echo $img[1];?>" style="height:100px;width: 100px">
													<?php
} else {
	?>
													<img class="img-responsive center-block" alt="" src="/assets/Customer/img/icon/bottomIcon2.png" style="height:100px;width: 100px">
													<?php
}
...
?>
											...
											<div class="col-md-2 col-sm-12" style="padding: 0">
												<p style="margin-top: 40px;"><strong>Order No:</strong> &nbsp;1232323</p>
												<p><strong>Amount:</strong>&nbsp;KD&nbsp;<?php echo number_format($proData->price, 3);?></p>
												<p><strong>Date: </strong>&nbsp; <?php echo date('d/m/Y', strtotime($proData->to_date));?></p>

											</div>
											<div class="col-md-3 col-sm-12">
											<p style="margin-top: 60px;font-weight: bold;">Points Gained/Used:</p>
											<p style="font-weight: bold;">Balance:</p>
											</div>
											<div class="col-md-4 col-sm-12" style="color:#73B720">
											<div class="margin40"></div>
											<div class="row">
												<div class="col-md-6">
													<p class="text-center">Mataam Points</p>
													<p class="text-center">10</p>
													<p class="text-center">120</p>
												</div>
												<div class="col-md-6">
													<p class="text-center">Restaurant Points</p>
													<p class="text-center">10</p>
													<p class="text-center">120</p>
												</div>
											</div>
