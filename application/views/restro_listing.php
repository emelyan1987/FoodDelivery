                                            ...
                                            <div class="border">
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="col-sm-6 col-md-6">
                                                        ...
                                                        {
                                                        ?>
                                                        <img class="img-responsive" alt="" src="<?php $img = explode('public_html',$vs->restaurant_logo); 
                                                    echo $img[1];?>">
                                                        <?php
                                                        }
                                                        else
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <a href="/restaurant_view/<?php echo $vs->id; ?>"><h4><?php echo ucwords($vs->restro_name); ?></h4></a>
                                                    <div class="ratings">
                                                        <?php 
