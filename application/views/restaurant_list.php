            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="filterHeader">
                        <img src="/assets/Customer/img/icon/smallLogo.png" alt="">
                        <span>Filters</span> 
                    </div>
                     ...
                     <ul class="filterList"> 
                        <li>
                            <div class="roundedOne">
                                <input type="checkbox" value="ALL"  onClick="checkCon1(this.id)" id="roundedOne" class="myCheckBox1" name="check" <?php if(@$_SESSION['filter_id'] == 1){ echo 'checked="checked"'; } ?>/>
                                <label for="roundedOne"><span>All</span></label>
                            </div>
                        </li>
                        <li>
                            <div class="roundedOne">
                                <input type="checkbox" value="2" onClick="checkCon1(this.id)" id="roundedOne1" class="myCheckBox2" name="check2" <?php if(@$_SESSION['filter_id'] == 2){ echo 'checked="checked"'; } ?>/>
                                <label for="roundedOne1"><span>Featured</span></label>
                            </div>
                        </li>
                        <li>
                            <div class="roundedOne">
                                <input type="checkbox" value="3" onClick="checkCon1(this.id)" id="roundedOne2" name="check3" <?php if(@$_SESSION['filter_id'] == 3){ echo 'checked="checked"'; } ?> />
                                <label for="roundedOne2"><span>Promotion</span></label>
                            </div>
                        </li>
                        <li>
                            <div class="roundedOne">
                                <input type="checkbox" value="4" onClick="checkCon1(this.id)" id="roundedOne3" name="check4"  <?php if(@$_SESSION['filter_id'] == 4){ echo 'checked="checked"'; } ?> />
                                <label for="roundedOne3"><span>Coupons</span></label>
                            </div>
                        </li>
                    </ul>
                    <div class="greenBorder"></div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <ul class="nav nav-tabs nav-justified myTabs restrotab" id="mind">
                                    ...
                                    <li <?php if($k == 1){ ?>class="active" <?php } ?> ><a data-toggle="tab" href="#tab1" onclick='myservicefun("<?php echo $b->id; ?>");'>
                                          ...
                                          <div class="col-md-12">
                                            <div class="border">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div><a href="/restaurant_view/<?php echo $vs->id; ?>" class="list-button">Go to menu <i class="fa fa-angle-right"></i></a></div>
                                                </div>
                                            </div>
                                          </div>
                                      </div>
           ...
           function checkCon(id)
            {
                     ...
                     $(document).ready(function($) {  
                      ...
                      document.getElementById('hiddenCuisineId').value = group;
