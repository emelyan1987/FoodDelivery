...
<div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-12">
                        ...
                        <a href="/restaurant_view/<?php echo $_SESSION['order_restro_id']; ?>"><h4><i class="fa fa-angle-left"></i> Back to restaurant</h4></a>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="padTB10">
                                                                ...
                                                                <div class="roundedOne">
                                                                    <input type="radio" value="1" onClick="checkCon(this.id)"  id="roundedOne3" class="myCheckBox1" name="hd_orderTime" />
                                                                     <label for="roundedOne3"><span>Order Now</span></label>
                                                                </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="padTB10">
                                                                <div class="roundedOne">
                                                                    ...
                                                                    <div class="roundedOne">
                                                                        <input type="radio" value="2" onClick="checkCon(this.id)"  id="roundedOne4" class="myCheckBox1" name="hd_orderTime" />
                                                                        <label for="roundedOne4"><span>Scheduled for : </span></label>
                                                                    </div>
                                                            ...
                                                            <div class="padTB10" id="sheduledate" style="display:none;">
                                                                <div class="col-md-6">
                                                                    <input type="text" name="scheduled_date" value="<?php echo date('Y-m-d'); ?>" id="scheduled_date" class="form-control">
                                                                </div>
                                                                <div class="col-md-6">
                                                                        <input type="text" name="scheduled_time" value="<?php echo date('H:i'); ?>" class="form-control text-center openTimeController" id="scheduled_time">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="col-md-offset-4 col-md-4">
                                                    <button type="submit" name="btncheckout" class="btn btn-yellow btn-yellow-new btn-block"><img src="/assets/Administration/images/icon/cartIcon.png" alt=""> CHECKOUT</button>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="margin20"></div>
                                    ...
                                    <div class="itemCheck" id="show_cartdata">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-sm-6">
                                                    <a href="/restaurant_view/<?php echo $_SESSION['order_restro_id']; ?>" class="btn btn-success btn-block"><i class="fa fa-plus"></i> Add More Items</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="margin20"></div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="border">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <span>Qty : <?php echo $ca->quantity; ?> </span><br>
                                                            <span>Price : KD <?php echo $ca->price; ?></span>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <h4>Total</h4>
                                                            <h4>KD <?php echo $tot = $ca->price * $ca->quantity; ?></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
           ...
           function checkCon(id)
            {
             ...
             if(id=="roundedOne4")
              {
                   $("#roundedOne4").attr("checked","checked");
