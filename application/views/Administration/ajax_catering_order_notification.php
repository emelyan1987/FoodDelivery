<div class="heading" style="    background: #FF8205;">Pending Orders</div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                        ...
                                        <td><a href="/catering_order_view/<?php echo $ord->id; ?>"><i class="fa fa-eye"></i></a>
                                          &nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onClick="delete_order(this.id,2)" id="<?PHP echo $ord->id; ?>" class="delete" >x</a>
                                        </td>
                                    </tr>
                                    <?php
                                    endforeach;
