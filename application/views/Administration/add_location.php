            ...
            <section class="content">
                <div class="row">
                    ...
                    <tr><td>TELEPHONES:</td>
                        ...
                        <td><input id="telephones2" name="telephones2" type="text" placeholder="TELEPHONES No. 2"/></td>
                    </tr>
                    <tr><td></td>
                            ...
                            <table class="table table_design">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <!--<td><span id="pickup_count"><?php //categoryCountByService(4,$restro_id,$location_id); ?></span>  <a href="#" id="cat_pickup_color" class="btn border-gray text-black" data-toggle="modal" data-target="#category" onclick="mycategory(4)"><span class="add_sign">+</span> Add</a></td>-->
                                    ...
                                    <tr>
                                        <td><input id="Radio6" type="checkbox" name="service_delivery" value="1" /> <span id="delivery_font">DELIVERY</span></td>
                                        <td>KD <input id="C_amount_delivery" type="text" value=""  name="C_amount_delivery"  onkeyup="comFun1(this.value,'C_percent_delivery')" />
                                            &nbsp;or&nbsp;
                                            <input id="C_percent_delivery" type="text" value=""  class="text-right"   name="C_percent_delivery"  onkeyup="comFun1(this.value,'C_amount_delivery')"/> %</td>
                                        <!--<td><span id="delivery_count"><?php //categoryCountByService(1,$restro_id,$location_id); ?></span> <a href="#" id="cat_delivery_color" class="btn border-gray text-black" data-toggle="modal" data-target="#category" onclick="mycategory(1)"><span class="add_sign">+</span> Add</a></td>-->
                                   ...
                                   <tr>
                                        <td><input id="Radio9" type="checkbox"  name="service_reservation" value="1" /> <span id="reservation_font">RESERVATION</span></td>
                                        <td>KD <input id="C_amount_reservation" type="text" value="" name="C_amount_reservation"  onkeyup="comFun1(this.value,'C_percent_reservation')"/>
                                            &nbsp;or&nbsp;
                                            <input id="C_percent_reservation" type="text" value=""  class="text-right"  name="C_percent_reservation"  onkeyup="comFun1(this.value,'C_amount_reservation')"/> %</td>
                                        <!--<td>N/A</td>-->
                                    ...
                                    <tr>
                                        ...
                                        <td>KD <input id="C_amount_catering" type="text" value=""  name="C_amount_catering"   onkeyup="comFun1(this.value,'C_percent_catering')"/>
                                            &nbsp;or&nbsp;
                                            <input id="C_percent_catering" type="text" value=""  class="text-right"   name="C_percent_catering"   onkeyup="comFun1(this.value,'C_amount_catering')"/> %</td>
                                        <!--<td><span id="catering_count"><?php //categoryCountByService(2,$restro_id,$location_id); ?></span> <a href="#" id="cat_catering_color" class="btn border-gray text-black" data-toggle="modal" data-target="#category" onclick="mycategory(2)"><span class="add_sign">+</span> Add</a></td>-->
            ...
            <section class="content">
                <div class="row">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="delivery_min_order" id="delivery_min_order" placeholder="MIN ORDER"> </td>
                    </tr>
                    <tr>
                        <td>ORDER TIME:</td>
                        <td>
                          <!--<input type="text" name="delivery_order_time" id="delivery_order_time">-->
                          <div class="col-md-2">
            ...
            <section class="content">
                <div class="row">
                    ...
                    <tr><td width="30%">MIN ORDER:</td>
                        <td><input type="text" name="catering_min_order" id="catering_min_order"  placeholder="MIN ORDER">
                            </td></tr>
                    <tr><td>ORDER TIME:</td>
                        <td>
...
$('.MyPickupLink').bind('click', false);
 $('#Radio3').click(function() 
 {
    if($(this).is(":checked"))
    {
       $("img#im_pickup").attr("src","http://restro.powersoftware.eu/assets/Administration/images/icon/setup_blue.png");  
    ...
    {
        $("img#im_pickup").attr("src","http://restro.powersoftware.eu/assets/Administration/images/icon/setup_gray.png");
...
$('.MyDeliveryLink').bind('click', false);
 $('#Radio6').click(function() 
 {
    if($(this).is(":checked"))
    {
       $("img#im_delivery").attr("src","http://restro.powersoftware.eu/assets/Administration/images/icon/setup_blue.png");
    ...
    {
        $("img#im_delivery").attr("src","http://restro.powersoftware.eu/assets/Administration/images/icon/setup_gray.png");   
...
$('.MyReservationLink').bind('click', false);
 $('#Radio9').click(function() 
 {
    if($(this).is(":checked"))
    {
       $("img#im_reservation").attr("src","http://restro.powersoftware.eu/assets/Administration/images/icon/setup_blue.png"); 
    ...
    {
        $("img#im_reservation").attr("src","http://restro.powersoftware.eu/assets/Administration/images/icon/setup_gray.png");  
...
$('.MyCateringLink').bind('click', false);
 $('#Radio12').click(function() 
 {
    if($(this).is(":checked"))
    {
       $("img#im_catering").attr("src","http://restro.powersoftware.eu/assets/Administration/images/icon/setup_blue.png"); 
    ...
    {
        $("img#im_catering").attr("src","http://restro.powersoftware.eu/assets/Administration/images/icon/setup_gray.png"); 
