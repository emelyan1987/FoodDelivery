...
<div class="content-wrapper">
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <h4 class="border_bottom">ADD AND MANAGE ADVERTISEMENTS - WEB</h4>                   
                        ...
                        <tbody>
                            <?php
                                foreach($AdvertiseType as $Ad => $adVer):
                                    ...
                                    $AdvertData = getAdvertData($adVer->id,1);
                                            ...
                                            <div class="col-md-12">
                                                <?php
                                                    foreach($AdvertData as $adv => $advImg):
                                                        ...
                                                        ?>
                                                        <div class="col-md-3" >
                                                            <a href="/delete_advertise_img/<?php echo $advImg->id; ?>" class="delete" style="    float: right;
                                                                position: absolute;
                                                                top: 12px;
                                                                right: 28px;background: #6B6B6B;">x</a>
