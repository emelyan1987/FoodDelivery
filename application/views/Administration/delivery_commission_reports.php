                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <h2 style="margin-top:-4px;float:left">Delivery Commission</h2>               <!--<div style="float:right;"> <select class="form-control">
...
?>
                                    <tr>
                                        ...
                                        <td>KD <?php $locData = getRestroCommissionData($ord->order_restro_id, $ord->restro_location_id, 1);
