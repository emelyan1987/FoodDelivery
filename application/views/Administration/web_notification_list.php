...
<section class="content">
         ...
         <div class="box">
                <div class="box-header">
                  <a href="/add_notification/web" class="btn bg-gray-light2"><span class="add_sign">+</span> Add New</a>
                  <br>
                  <br>
                  <h3 class="box-title">List of Web Notification</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                          ...
                          <a href="javascript:void(0)" onClick="updateNotification(this.id)" id="<?PHP echo $vs->id; ?>@@<?PHP echo $vs->message; ?>@@<?PHP echo $vs->date; ?>@@<?PHP echo $vs->time; ?>@@<?PHP echo $vs->status; ?>"  class="edit border-gray padding_less"><i class="fa fa-pencil text-blue" aria-hidden="true"></i></a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">UPDATE WEB NOTIFICATION </h4>
      </div>
      <div class="modal-body">
             <div class="table-responsive">
                    ...
                    <tr><td width="20%">DATE:</td>
                        <td><input  type="text" style="width:60%;"  name="date" placeholder="yyyy-mm-dd" 
						id="note_date" >
                            <br>
...
<script>
         ...
         {
			  var cn=confirm("Dow you want to delete this notification?");
               if(cn==true)
			   {
                 $.ajax({
                                 method:"post",
