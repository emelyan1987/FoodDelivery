                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <h2 style="margin-top:-4px;float:left">PENDING Orders</h2>               <!--<div style="float:right;"> <select class="form-control">
                            ...
                            <table id="example1" class="table table-striped table-bordered table_design">
                                <thead>
                                    <tr class="bg-green">
                                        <th colspan="11" style="color:white;">DELIVERY</th>
                            ...
                            <input type="hidden" name="urlName" value="<?php echo $this->uri->segment(1); ?>" >
                    </div>
                    </div>
                </div>
            </section>
