...
<section class="content">
          <div class="row">
            <div class="col-xs-12">
         <div class="box">
          <a href="/restaurant_tables" class="btn bg-gray-light2"> Back to Restaurant tables</a>
                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <!--<td><?php if($vs->status == 0){ ?><a href="" class="btn btn-info" onclick='BookedFun("<?php echo $vs->id; ?>")'>Booking Confirm</a> <?php } ?></td>-->
