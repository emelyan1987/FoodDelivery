                                        ...
                                        <div class="border">
                                            <div class="col-md-12">
                                                <div class="col-md-4 col-sm-4">
                                                    <div class="row">
                                                        <img class="img-responsive img-menu" src="<?php getImagePath($TE->image);?>" alt="">
                                                    </div>
                                                </div>
                                                <div class="col-md-8 col-sm-8 item-desc">
                                                    <a href="/view_restro_item/<?php echo $restro_id;?>/<?php echo $TE->id;?>" ><h4><?php echo ucwords($TE->item_name);?></h4></a>
