                    ...
                    <div class="row">
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                          <ul class="nav navbar-nav">
                            <li class="dropdown">
                                <div class="languageOption">Choose Language 
                                        <ul class="translation-links">          
                                       <li>

                                       <a href="javascript:void(0);" class="arabic" data-lang="Arabic"><img src="<?php echo base_url(); ?>assets/Customer/img/icon/languageIcon1.png" alt=""></a>
                                       <a href="javascript:void(0);" class="english" data-lang="English"><img src="<?php echo base_url(); ?>assets/Customer/img/icon/languageIcon2.png" alt=""></a>
                                       </li> </ul>
                                  </div>
                          ...
                          <ul class="nav navbar-nav navbar-right">
                            ...
                            echo '<a href="/customer_dashboard/orders"><i class="fa fa-user"></i> My Account </a>';
                            }
                            else
                            {
                            ?>
                                <a href="#" data-toggle="modal" data-target="#loginModel">Login</a>
                            ...
                            ?><li><a href="/customer_logout/"><i class="fa fa-sign-out"></i>
                            Logout</a></li>
                            <?php
                            }
                            ?>
                            ...
                            ?>
                                                      ...
                                                      <li><a href="/mycart/" class="cartBtn"><?php mycartValue($_SESSION['Customer_User_Id']); ?><img src="/assets/Administration/images/icon/cartIcon.png"></i> My Cart</a></li>
                            <?php
                            }
                            else
                            {
                              ?>
                                                <li><a href="#" class="cartBtn"><img src="/assets/Administration/images/icon/cartIcon.png"></i> My Cart</a></li>
                              <?php
                            }
                            ?>
                          </ul>
