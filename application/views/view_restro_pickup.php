...
<div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-12">
                    <div class="searchBox">
                        <a href="/pickup_restaurant/<?php echo $ES->id; ?>"><h4><i class="fa fa-angle-left"></i> Back to restaurant</h4></a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ul class="nav nav-pills nav-stacked newTabStyle">
                                ...
                                <li>
                                    <a href="/pickup_restaurant/<?php echo $ES->id; ?>" >
                                        <img class="menuListImg" src="/assets/Customer/img/icon/smallLogoCss.png">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-5">
                                                <div class="center-block quantity">
                                                    ...
                                                    <button type="button" class="btn-minus-blue" onclick="incrementval('quantity_user')"><b><i class="fa fa-plus"></i></b></button>
                                                    <div class="margin20"></div>
                                                </div>
                                            </div>
                                            <div class="col-sm-7">
                                                ...
                                                <button type="submit" name="btnaddtocart" class="btn btn-yellow btn-yellow-new-sm btn-block">
<img src="/assets/Administration/images/icon/cartIcon.png" alt=""> AD TO CART</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="itemCheck">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-sm-6">
                                                    <a href="/pickup_restaurant/<?php echo $ES->id; ?>" class="btn btn-primary btn-block"><i class="fa fa-plus"></i> Add More Items</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="margin20"></div>
                         ...
                         if($shobtn == 1)
                        {
                                                ...
                                                {
                                                ?>
                                                    <button type="submit" name="addtocartbtn" class="btn btn-yellow btn-yellow-new btn-block">
<img src="/assets/Administration/images/icon/cartIcon.png" alt=""> AD TO CART</button>
                                                ...
                                                {
                                                ?>
                                                    <button type="button" class="btn btn-yellow btn-yellow-new btn-block" data-toggle="modal" data-target="#myModal">
<img src="/assets/Administration/images/icon/cartIcon.png" alt=""> AD TO CART</button>
                                                <?php
                                                }
                        }
