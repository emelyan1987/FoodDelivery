...
<div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-12">
                    <div class="searchBox">
                        <a href="/restaurant_view/<?php echo $ES->id; ?>"><h4><i class="fa fa-angle-left"></i> Back to restaurant</h4></a>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ul class="nav nav-pills nav-stacked newTabStyle">
                                <li class="active">
                                    <a href="/restaurant_view/<?php echo $ES->id; ?>" aria-expanded="true">
                                ...
                                <li>
                                    <a href="/restaurant_view/<?php echo $ES->id; ?>" >
                                        <img class="menuListImg" src="/assets/Customer/img/icon/smallLogoCss.png">
                                    ...
                                    <div class="itemCheck">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-sm-6">
                                                    <a href="/restaurant_view/<?php echo $ES->id; ?>" class="btn btn-success btn-block"><i class="fa fa-plus"></i> Add More Items</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="margin20"></div>
