...
<div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="searchBox">
                        <a href="/filter/"><h4><i class="fa fa-angle-left"></i> Back to restaurant list</h4></a>
                    </div>
                    <div class="row">
                        <div class="col-sm-3">
                        	<?php 
                                        ...
                                        <div class="col-md-6">
                                            <div class="border">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <a href="/view_restro_item/<?php echo $ES->id; ?>/<?php echo $TE->id; ?>" class="rest-link"><h4><?php echo ucwords($TE->item_name); ?></h4></a>
