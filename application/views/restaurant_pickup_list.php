                ...
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs nav-justified myTabs">
                        <?php
                            ...
                            ?>
                            <li <?php if ($k == 4) {?>class="active" <?php }
                                    ...
                                    <div class="col-md-12">
                                        <div class="border">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <label class="list-label" style="width:45%">Delivery Time:</label>
                                                <label class="list-data" style="width:55%"><?php if ($vs->order_days != 0) {echo $vs->order_days . " Day ";}
                                                ...
                                                <label class="list-label" style="width:45%">Payment:</label>
                                                <label class="list-data" style="width:55%">
                                                    <?php
