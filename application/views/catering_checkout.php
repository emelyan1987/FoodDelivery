...
<div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-12">
                        ...
                        <a href="/catering_restaurant/<?php echo $_SESSION['order_restro_id']; ?>"><h4><i class="fa fa-angle-left"></i> Back to restaurant</h4></a>
                                            ...
                                            <div class="col-sm-12 col-sm-12 col-md-12">
                                                ...
                                                <div class="col-sm-3 col-sm-3 col-md-3">
                                                    <div class="form-horizontal">
                                                        <div class="col-sm-12">
                                                            <input type="text" name="Ddate" value="<?php echo $_SESSION['cat_date']; ?>" id="datepicker" class="form-control">
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="itemCheck" id="show_cartdata">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-sm-6">
                                                    <a href="/catering_restaurant/<?php echo $_SESSION['order_restro_id']; ?>" class="btn btn-warning btn-block"><i class="fa fa-plus"></i> Add More Items</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="margin20"></div>
