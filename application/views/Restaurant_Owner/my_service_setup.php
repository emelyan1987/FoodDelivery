...
<section class="content">
  ...
  <form action="" method="post" >
                <div class="row">
                    ...
                    <h4 class="border_bottom">Service Name - Delivery</h4>                   

                    <div class="table-responsive">
                    <table class="table bg-gray-light tbl" style="width:80%;">
                    <tbody><tr><td width="30%">MIN ORDER:</td>
                          <td>
                              <div class="col-md-1">KD</div>
                              <div class="col-md-11"><input type="text" value="<?php echo $restroWork['min_order']; ?>" name="min_order"></div>
                          </td>
                    </tr>
                    <tr><td>ORDER TIME:</td>
                        <td>
			  ...
			  <input type="hidden" name="dordert_second" value="0">
                    ...
                    <!--<tr><td>DELIVERY CHARGES PER ORDER</td>
                        <td>
                            <div class="col-md-1">KD</div>
                            <div class="col-md-11"><input type="text" value="<?php //echo $restroWork['delivery_charges']; ?>" name="delivery_charges"></div>
                        </td>
                    </tr>-->
                    ...
                    <tr><td>Monday:</td>
                        ...
                        <td>
                        	 <input type="text"  id="delivery_monday_from" name="monday_from"  value="<?php if($restroWork['monday_from'] != ''){ echo $restroWork['monday_from']; }else{ echo '10:00 AM'; } ?>">
                        </td>
                        <td>
                        	<input type="text" id="delivery_monday_to"  name="monday_to" value="<?php if($restroWork['monday_to'] != ''){ echo $restroWork['monday_to']; }else{ echo '11:00 PM'; } ?>">
                        </td>
                    </tr>
                    <tr><td>Tuesday:</td>
                        ...
                        <td>
                           <input type="text"  id="delivery_tuesday_from" name="tuesday_from" value="<?php if($restroWork['tuesday_from'] != ''){ echo $restroWork['tuesday_from']; }else{ echo '10:00 AM'; } ?>">
                        </td>
                        <td>
                          <input type="text"  id="delivery_tuesday_to" name="tuesday_to" value="<?php if($restroWork['tuesday_to'] != ''){ echo $restroWork['tuesday_to']; }else{ echo '11:00 PM'; } ?>">
                        </td>    
                    </tr>
                    <tr><td>Wednesday:</td>
                        ...
                        <td>
                           <input type="text"  id="delivery_wednesday_from" name="wednesday_from" value="<?php if($restroWork['wednesday_from'] != ''){ echo $restroWork['wednesday_from']; }else{ echo '10:00 AM'; } ?>">
                        </td>
                        <td>
                          <input type="text"  id="delivery_wednesday_to"  name="wednesday_to" value="<?php if($restroWork['wednesday_to'] != ''){ echo $restroWork['wednesday_to']; }else{ echo '11:00 PM'; } ?>">
                        </td>   
                    </tr>
                    ...
                    <tr><td>Thursday:</td>
                        ...
                        <td>
                           <input type="text" id="delivery_thursday_from" name="thursday_from" value="<?php if($restroWork['thursday_from'] != ''){ echo $restroWork['thursday_from']; }else{ echo '10:00 AM'; } ?>">
                        </td>
                        <td>
                          <input type="text" id="delivery_thursday_to" name="thursday_to" value="<?php if($restroWork['thursday_to'] != ''){ echo $restroWork['thursday_to']; }else{ echo '11:00 PM'; } ?>">
                        </td>    
                    </tr>
                    <tr><td>Friday:</td>
                        ...
                        <td>
                           <input type="text" id="delivery_friday_from" name="friday_from" value="<?php if($restroWork['friday_from'] != ''){ echo $restroWork['friday_from']; }else{ echo '10:00 AM'; } ?>">
                        </td>
                        <td>
                          <input type="text" id="delivery_friday_to" name="friday_to" value="<?php if($restroWork['friday_to'] != ''){ echo $restroWork['friday_to']; }else{ echo '11:00 PM'; } ?>">
                        </td>     
                    </tr>
                    <tr><td>Saturady:</td>
                        ...
                        <td>
                           <input type="text"  id="delivery_saturday_from"  name="saturday_from" value="<?php if($restroWork['saturday_from'] != ''){ echo $restroWork['saturday_from']; }else{ echo '10:00 AM'; } ?>">
                        </td>
                        <td>
                          <input type="text" id="delivery_saturday_to"  name="saturday_to" value="<?php if($restroWork['saturday_to'] != ''){ echo $restroWork['saturday_to']; }else{ echo '11:00 PM'; } ?>">
                        </td>
                    </tr>
                    ...
                    <tr><td>Sunday:</td>
                        ...
                        <td>
                           <input type="text" id="delivery_sunday_from" name="sunday_from" value="<?php if($restroWork['sunday_from'] != ''){ echo $restroWork['sunday_from']; }else{ echo '10:00 AM'; } ?>">
                        </td>
                        <td>
                          <input type="text" id="delivery_sunday_to"  name="sunday_to" value="<?php if($restroWork['sunday_to'] != ''){ echo $restroWork['sunday_to']; }else{ echo '11:00 PM'; } ?>">
                        </td>
                    </tr>
