...
<!-- Content Wrapper. Contains page content -->
          <div class="content-wrapper">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-md-12">
                    <a href="/restro_catering_order/" class="btn bg-gray-light2">< &nbsp;Back to previous page</a>
                    ...
                    <ul class="listOdnary">
                            ...
                            <li><div class="listOdnaryTitle">Order Type:</div><div class="listOdnaryDetail"> CATERING </div></li>
                            <li><div class="listOdnaryTitle">Total Order Amount:</div><div class="listOdnaryDetail" id="totalAmounttext"> KD 0.00 </div></li>
                            <li><div class="listOdnaryTitle">Delivery Date:</div><div class="listOdnaryDetail"> <?php echo $ordD->date; ?></div></li>
                            <li><div class="listOdnaryTitle">Delivery Time: </div> <div class="listOdnaryDetail"><?php echo $ordD->time; ?></div></li>
<?php
