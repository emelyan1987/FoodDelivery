...
<form role="form" method="post" action='' enctype ="multipart/form-data" >
      <div class="row">
                    <div class="col-md-12">
                    <a href="/restro_item_list/" class="btn bg-gray-light2">&lt; &nbsp;Back to Edit Menu Item</a>
  ...
  <strong>Success!</strong> <?php echo $success_msg; ?>
		    ...
		    <tr>
                        ...
                        {
                        ?>
                        <tr><td colspan="2"><img src="<?php getImagePath($itmD->image); ?>" height="200px"></td></tr>
                        <?php
                        }
                        ?>
                    ...
                    <tr>
                        ...
                        <td>
                        <div class="col-md-12">
                            <input type="radio" name="price_type" value="1" onclick="variation_price(this.value);" <?php if($itmD->price_type == 1){ echo "checked"; } ?>>
                            Price will be added by Variation price for this item
                        </div>
                        <div class="col-md-12">
                            <input type="radio" name="price_type" value="2" onclick="variation_price(this.value);" <?php if($itmD->price_type == 2){ echo "checked"; } ?>>
                            Have to enter the price of item and variation price will be extra for this item
                        </div>
                      </td>
                    </tr>

                    <tr id="priceDiv" <?php if($itmD->price_type == 1){ echo 'style="visibility:hidden"'; } ?>>
                        <td>PRICE</td>
                    ...
                    <tr><td>POINTS</td>
                        <td>
                            <div class="col-md-6">
                                When Amount <input type="number" name="order_point_amount" Placeholder="Amount" class="form-control"  value="<?php echo $itmD->order_point_amount; ?>">
                            </div>
                            <div class="col-md-6">
