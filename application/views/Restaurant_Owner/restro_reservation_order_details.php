...
<!-- Content Wrapper. Contains page content -->
          <div class="content-wrapper">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-md-12">
                    <a href="/restro_reservation_order/" class="btn bg-gray-light2">< &nbsp;Back to previous page</a>
              ...
              ?>
               ...
               ?>           
                    ...
                    <table class="table table_design">
                        ...
                        <tr>
                            <td>
                                <p>1.  This product was ordered by the customer from the above-mentioned restaurant via Mataam, which acts as an intermediary between customers and the subscribed restaurants.</p>

<p>2.  This transaction is subject to the terms and conditions of the use of Mataam, which are listed on our website. By entering into this transaction the customer is deemed to have read and accepted these terms and conditions.</p>

<p>3.  The purpose of this summary is to display and record the details of this transaction. It should not be regarded as an invoice issued by the restaurant.</p>

<p>4.  Mataam has no involvement in the preparation, production, pricing or delivery of this product. The restaurant has sole responsibility for these processes, as well as for the quality and validity of the product.</p>

<p>5.  Mataam accepts no responsibility for any damage or injury that may arise from this transaction. In the event of a complaint, the customer is requested to contact Mataam in order for us to pursue the issue with the restaurant.</p>

<p>6.  As per the contract between Mataam and the restaurant, the restaurant is solely responsible for its online menu content including descriptions, images and prices of menu items, discount coupons and promotions, minimum order values and delivery fees. Mataam accepts no responsibility or legal liability arising from any discrepancy between the menu content displayed on Mataam and the restaurant’s own delivery menu. We encourage Mataam users to advise us of any discrepancies found, in order for us to raise them with the restaurant concerned.</p>
