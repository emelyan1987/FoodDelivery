...
<!-- Content Wrapper. Contains page content -->
          <div class="content-wrapper">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-md-12">
                    <a href="/restro_pickup_order/" class="btn bg-gray-light2">< &nbsp;Back to previous page</a>
                    ...
                    <ul class="listOdnary">
                            ...
                            <li><div class="listOdnaryTitle">Order Type:</div><div class="listOdnaryDetail"> PICKUP </div></li>
...
?>
  <div class="dropdown-menu">
    <div class="col-md-12">
        <a class="dropdown-item" href="javascript:void(0)" onclick='payFun(4,"<?php echo $ordD->id; ?>",0);'>
        <div class="col-md-12 btn-default mystatusClass">
                Pending
        </div>
        </a>
        <a class="dropdown-item" href="javascript:void(0)" style="color:#fff;" onclick='payFun(4,"<?php echo $ordD->id; ?>",1);'>
