...
<?php echo form_open_multipart('') ?>
   <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        <div class="third_half">
                            <div class="col-md-12 get-outbox">
                				<h1>Get started</h1>
								<h2> <?php if(isset($successMsg)) { echo $successMsg; } ?></h2>
                			</div>
    	...
    	`									</select>
                			...
                			<div class="col-md-12 choose-outbox">
                            ...
                            <div class="col-md-12">
                              ...
                              <div class="col-md-12 line_sectionpadding">
                                         <hr/>
                                     </div>

                    		<div class="row">
                            	<div class="col-md-12 work_outbox">
...
<input name="work_time" id="roundedOne" value="1" type="checkbox">
...
<div class="roundedOne">
<input value="2" onclick="checkCon1(this.id)" id="roundedOne1" class="myCheckBox2" name="work_time" type="checkbox">
...
<div class="roundedOne">
<input value="3" onclick="checkCon1(this.id)" id="roundedOne2" name="work_time" checked="checked" type="checkbox">
...
<span class="input-group-addon time_bg_top_section"><i class="glyphicon glyphicon-time"></i></span>
  <input id="timepicker1 " name="from" type="text" class="form-control input-small time_bg_section">
...
<span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
  <input id="timepicker2" name="to" type="text" class="form-control input-small time_bg_section">
  ...
  $('#timepicker2').timepicker({
    showInputs: false
        ...
        <input type="file"  name="restro_logo" id="fileupload">
                       ...
                       <div class="row">
                            	<div class="col-md-12 gray_sectionoutbox">
                                	<div class="col-md-6">
...
<script>
    ...
    if (div.style.display !== "none") {
		...
		document.getElementById("pick_up_img2").value="4";
    }
    else {
  ...
  <script>
    ...
    if (div.style.display !== "none") {
        div.style.display = "none";
		div1.style.display = "block";
		 document.getElementById("delivery_img2").value="1";
    }
    else {
        div.style.display = "block";
		div1.style.display = "none";
...
<script>
    ...
    if (div.style.display !== "none") {
        div.style.display = "none";
		div1.style.display = "block";
	    document.getElementById("res_img2").value="3";
    }
    else {
        div.style.display = "block";
		div1.style.display = "none";
...
<script>
    ...
    if (div.style.display !== "none") {
        div.style.display = "none";
		div1.style.display = "block";
		document.getElementById("cat_img2").value="2";
    }
    else
	 {
        $("#div1").hide("fast");
